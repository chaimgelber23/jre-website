...
export default function BanquestSetupPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Request token from Collect.js - this will trigger handleTokenReceived
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12">
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg p-8">
        ...
        <p className="text-gray-600 mb-6">Test the Banquest JSON API integration</p>
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="text-xs space-y-1 text-gray-600">
            <p>Card Valid: {cardValid ? "Yes" : "No"}</p>
            <p>Token: {paymentToken ? paymentToken.substring(0, 20) + "..." : "None"}</p>
        ...
        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
          <h3 className="font-medium text-blue-800 mb-2">Test Card Numbers</h3>
          <div className="text-xs space-y-1 text-blue-700">
            <p><strong>Visa:</strong> 4111 1111 1111 1111</p>
            <p><strong>Mastercard:</strong> 5431 1111 1111 1111</p>
            <p><strong>Amex:</strong> 3411 1111 1111 1111</p>
