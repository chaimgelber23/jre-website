...
export default function BatMitzvahNowWhatPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/events/bat-mitzvah-now-what/register", {
        method: "POST",
                ...
                <div className="p-8 space-y-4">
                  ...
                  >
                    <div className="flex items-center gap-2 text-gray-700">
                      ...
                      <span>Sunday, March 22, 2026 at 10:00 AM</span>
                    </div>
                    <div className="flex items-center gap-2 text-gray-700">
                ...
                <form onSubmit={handleSubmit} className="px-8 py-8 space-y-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      style={{
                        // Applied via onFocus/onBlur for dynamic ring — using CSS below
                      }}
                      onFocus={(e) => {
